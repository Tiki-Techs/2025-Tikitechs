...
//import frc.robot.subsystems.KeyboardManager;
...
public class RobotContainer {
  ...
  // private final Controller m_controller = new Controller(m_elevator, m_arm,
  // m_intake);

  // Replace with CommandPS4Controller or CommandJoystick if needed
  public static final CommandXboxController m_driverController = new CommandXboxController(
      OperatorConstants.kDriverControllerPort);
  // private final CommandXboxController m_elevatorController = new
  // CommandXboxController(OperatorConstants.ELEVATOR_GAMEPAD_PORT);
  ...
  public RobotContainer() {
    ...
    KeyboardManager.aButton().onTrue(new InstantCommand(() -> m_intake.setSpeed(1.0)));
    KeyboardManager.bButton().onTrue(new InstantCommand(() -> m_intake.setSpeed(0)));
  ...
  private void configureBindings() {
    ...
    // KeyboardManager.getInstance().key("a").onTrue(new RunCommand(() ->
    // m_intake.setSpeed(1), m_intake));
