...
//       return tag.map(pose3d -> PhotonUtils.getDistanceToPose(RobotContainer.drivebase.getRobotPose().toPose2d(), pose3d.toPose2d())).orElse(1000.0);
//     }
...
//   // This is a suss function - need to test it; This method is taken from 1884 Griffins, and should be modified
...
//   // This method is derived from 1884 Griffins' Vision. We may want to use the NT4 getAtomic() that syncs rio FPGA and coprocessor clock.
//   public double getTotalLatency(String limelightName) {
//           return LimelightHelpers.getLatency_Pipeline(limelightName) + LimelightHelpers.getLatency_Capture(limelightName); // just replace visionconfig thing with limelight name
//   }


//   /**
//    * Gets the camera capture time in seconds. Only used for limelight; Taken from 1884 Griffins
//    *
